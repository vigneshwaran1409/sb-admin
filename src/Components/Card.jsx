                                        ...
                                        <div className="col mr-2">
                                            ...
                                            <div className="row no-gutters align-items-center">
                                                <div className="col-auto">
                                                    <div className="h5 mb-0 mr-3  ml-3 font-weight-bold text-gray-800">{cardData.price}%</div>
                                                </div>
                                                <div className="col">
                                                    <div className="progress progress-sm mr-2">
                                                        <div className={`progress-bar bg-${cardData.color}`} role="progressbar"
                                                            style={{width:`${cardData.price}%` ,ariaValueNow:`${cardData.price}%`, ariaValueMin:"0",
